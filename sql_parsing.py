...
if __name__ == "__main__":
    ...
    print("columns: ", result.columnsToShow)
    print("valuesList clause: ", result.tables)
...
# enregistrement={'nom':'Diop','prenom':'Mamadou','Age':17}
# def insertion(bd,table,enregistrement):
# 	with open(bd) as json_data:
# 	    data_dict = json.load(json_data)
# 	    liste=[]
# 	    liste=data_dict.copy()
# 	    liste[table].append(enregistrement)
# 	    data_dict=json.dumps(liste,indent=4)
# 	    #y = json.dumps(liste,indent=4)
# 	    #print(data_dict)
# 	    fichier = open(bd,'w')
# 	    fichier.write(data_dict)
# 	    fichier.close()
# insertion(bd,table,enregistrement)
# option=22
# colonne="Age"
# def supprimer(bd,table,option,colonne):
# 	with open(bd) as json_data:
# 	    data_dict = json.load(json_data)
# 	    liste=[]
# 	    liste=data_dict.copy()
...
# 	    fichier.write(data_dict)
# 	    fichier.close()
# #supprimer(bd,table,option,colonne)
# option="aliou"
# attribut="Modou"
# colonne="prenom"
# def update(bd,table,attribut,option,colonne):
# 	with open(bd) as json_data:
# 	    data_dict = json.load(json_data)
# 	    liste=[]
# 	    liste=data_dict.copy()
...
# 	    	if option==val[colonne]:
# 	    		liste[table].remove(val)
# 	    		val[colonne]=attribut
# 	    		liste[table].append(val)
# 	    data_dict=json.dumps(liste,indent=4)
# 	    #print(data_dict)
# 	    fichier = open(bd,'w')
# 	    fichier.write(data_dict)
# 	    fichier.close()
# #update(bd,table,attribut,option,colonne)
